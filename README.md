...
You can then execute your native executable with: `./target/quarkus-camel-kafka-consumer-1.0.0-SNAPSHOT-runner`
...
- Camel SEDA ([guide](https://access.redhat.com/documentation/en-us/red_hat_integration/2.latest/html/camel_extensions_for_quarkus_reference/extensions-seda)): Asynchronously call another endpoint from any Camel Context in the same JVM
